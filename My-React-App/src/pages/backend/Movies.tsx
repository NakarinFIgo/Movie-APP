import BackLayout from "@/component/layouts/BackLayout";
          ...
          <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-lg w-1/3">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                {errors.runtime && (
                  <p className="text-red-500 mb-4">{errors.runtime.message}</p>
                )}
                ...
                <input
                  ...
                  {...register("mpaa_rating", {
                    required: "MPAA Rating is required",
                  })}
                  className="border p-2 w-full mb-4"
                />
                {errors.mpaa_rating && (
                ...
                {errors.genres_array && (
                  <p className="text-red-500">{errors.genres_array.message}</p>
                )}
          ...
          <table className="min-w-full bg-white">
            <thead className="bg-gray-800 text-white">
              <tr>
                ...
                <th className="w-36 text-left py-3 px-4 uppercase font-semibold text-sm">
                  Manage
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              {movies.map((movie) => (
                <tr className="border-b border-gray-200">
                  ...
                  <td className="text-left py-3 px-4">
                    {movie.runtime > 0 ? movie.runtime : "N/A"}
                  </td>
                  <td className="text-left py-3 px-4">
                    {movie.mpaa_rating || "N/A"}
                  </td>
